...
// ✅ Sugerencias (NO obligatorias). Solo ayuda visual.
// Puedes agregar más aquí cuando quieras, pero el usuario puede escribir cualquiera.
...
export default function Home() {
  ...
  const [newCategoria, setNewCategoria] = useState("OTROS"); // ✅ ahora libre

  // EDIT state
  const [editingId, setEditingId] = useState<number | null>(null);
  const [editNombre, setEditNombre] = useState("");
  const [editPrecio, setEditPrecio] = useState("");
  const [editCategoria, setEditCategoria] = useState("OTROS"); // ✅ ahora libre
    ...
    try {
      const res = await fetch(`${baseUrl}/menu`, {
        ...
        body: JSON.stringify({
          nombre,
          precio: precioNum,
          categoria, // ✅ libre pero normalizada
        }),
      });
