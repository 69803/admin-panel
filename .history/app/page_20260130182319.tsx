...
export default function Home() {
  ...
  // ✅ NUEVO: filtro por categoría (para que ZAPATO salga como opción)
  ...
  // ✅ NUEVO: categorías reales detectadas desde DB
  ...
  // ✅ NUEVO: sugerencias del input = base + las que existan en DB
